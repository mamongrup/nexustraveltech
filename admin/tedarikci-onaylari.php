...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!hash_equals($_SESSION['admin_csrf'], (string) ($_POST['csrf'] ?? ''))) {
        ...
        if ($supplierId < 1 || !in_array($action, ['approve', 'reject'], true) || !$verification) {
