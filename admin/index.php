...
<body>
  <main class="wrap">
    ...
    <p><a class="logout" href="/nexustraveltech/admin/kontrol-merkezi">Platform kontrol merkezi →</a> &nbsp; | &nbsp; <a class="logout" href="/nexustraveltech/admin/uyari-merkezi">Operasyon uyarıları →</a> &nbsp; | &nbsp; <a class="logout" href="/nexustraveltech/admin/acenteler">Acente yönetimi →</a> &nbsp; | &nbsp; <a class="logout" href="/nexustraveltech/admin/otel-siniflandirma">Otel tipleri, yıldızlar ve temaları yönet →</a> &nbsp; | &nbsp; <a class="logout" href="/nexustraveltech/admin/otel-cevirileri">6 dilde çevirileri yönet →</a> &nbsp; | &nbsp; <a class="logout" href="/nexustraveltech/admin/ozellik-listeleri">Villa/yat ve otel özellik listeleri →</a> &nbsp; | &nbsp; <a class="logout" href="/nexustraveltech/admin/tedarikci-onaylari">Tedarikçi kimlik ve yetki onayları →</a> &nbsp; | &nbsp; <a class="logout" href="/nexustraveltech/admin/ai-ayarlari">DeepSeek metin AI →</a> &nbsp; | &nbsp; <a class="logout" href="/nexustraveltech/admin/gemini-ayarlari">Gemini görsel AI →</a></p>

    <p><a class="logout" href="/nexustraveltech/admin/timerlar">Zamanlayıcılar →</a> &nbsp; | &nbsp; <a class="logout" href="/nexustraveltech/admin/zamanlayici-gecmisi">Zamanlayıcı geçmişi →</a> &nbsp; | &nbsp; <a class="logout" href="/nexustraveltech/admin/netgsm-ayarlari">Netgsm SMS merkezi →</a> &nbsp; | &nbsp; <a class="logout" href="/nexustraveltech/admin/sms-yonetimi">SMS paket ve kredi yönetimi →</a> &nbsp; | &nbsp; <a class="logout" href="/nexustraveltech/admin/2fa">İki adımlı doğrulama →</a> &nbsp; | &nbsp; <a class="logout" href="/nexustraveltech/admin/kvkk">KVKK veri aracı →</a> &nbsp; | &nbsp; <a class="logout" href="/nexustraveltech/admin/eposta-sablonlari">E-posta şablonları →</a> &nbsp; | &nbsp; <a class="logout" href="/nexustraveltech/admin/denetim-kayitlari">Denetim kayıtları →</a> &nbsp; | &nbsp; <a class="logout" href="/nexustraveltech/admin/hata-izleme">Hata izleme →</a> &nbsp; | &nbsp; <a class="logout" href="/nexustraveltech/admin/ziyaretci-sohbet">Ziyaretçi sohbet kayıtları →</a> &nbsp; | &nbsp; <a class="logout" href="/nexustraveltech/admin/sohbet-raporu">Aylık sohbet raporu →</a></p>
