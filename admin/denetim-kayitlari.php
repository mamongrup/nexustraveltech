...
// CSV bağlantısı: aktif İŞLEM filtresi (chip) dahil tüm filtreleri taşır.
$csvUrl = $baseAudit . '?export=csv' . ($action !== '' ? '&action=' . urlencode($action) : '') . $filtersSuffix;
