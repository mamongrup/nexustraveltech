...
if (in_array($export, ['delete_impact', 'delete_type', 'bulk_impact', 'bulk_type', 'delete_supplier_summary', 'bulk_supplier_summary'], true) && $_SERVER['REQUEST_METHOD'] === 'GET') {
