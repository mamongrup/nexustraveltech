...
admin_layout_start('Katalog & Özellik Sınıflandırma Yönetimi', 'ozellik-listeleri');
?>

<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:20px;flex-wrap:wrap;gap:12px">
    <p style="color:var(--sui-muted);margin:0;font-size:14px">
        Otel sınıflandırmaları, villa/yat özellikleri ve otel etkinlik/aktivite katalogları.
    </p>
    <a href="otel-cevirileri" class="sui-btn sui-btn-outline sui-btn-sm">🌐 Çoklu Dil Çevirileri →</a>
</div>
