    ...
    try {
      ...
      if ($action === 'add') {
        ...
        if (empty($_POST['confirmed'])) {
          ...
          $setActionCookie('delete', $msg, ['label' => $res['label'], 'affected' => count($res['affected'])]);
        }
