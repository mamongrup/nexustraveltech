...
if (!table_guard(['property_feature_catalog', 'pending_trash_purges', 'trash_upcoming_alerts', 'feature_delete_backups'])) {
    fwrite(STDERR, "[alert-trash-upcoming] Eksik tablo — atlandı.
");
    exit(0);
}
