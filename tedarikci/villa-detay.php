...
<?php $readiness = listing_readiness($listing); $linkFor = ['rooms' => '/nexustraveltech/tedarikci/villa-detay?product='.$id.'#sec-04', 'rates' => '/nexustraveltech/tedarikci/fiyat-kontenjan?property='.$id, 'inventory' => '/nexustraveltech/tedarikci/fiyat-kontenjan?property='.$id, 'media' => '/nexustraveltech/tedarikci/villa-detay?product='.$id.'#sec-05', 'description' => '/nexustraveltech/tedarikci/villa-detay?product='.$id.'#sec-02', 'location' => '/nexustraveltech/tedarikci/villa-detay?product='.$id.'#sec-01', 'pool' => '/nexustraveltech/tedarikci/villa-detay?product='.$id.'#sec-01', 'home_port' => '/nexustraveltech/tedarikci/villa-detay?product='.$id.'#sec-01', 'crew' => '/nexustraveltech/tedarikci/villa-detay?product='.$id.'#sec-01', 'ical' => '/nexustraveltech/tedarikci/ical-takvimler', 'rules' => '/nexustraveltech/tedarikci/satis-kurallari?property='.$id]; /* Bölümler tek kaynaktan numaralanır — yeni bölüm eklerken yalnızca bu diziye satır ekle. */ $editorSections = ['Kimlik, sınıflandırma & konum' => 'Kimlik & konum', 'Satış içeriği & operasyon' => 'Satış içeriği', 'Özellikler & hizmetler' => 'Özellikler', $unitLabel.' envanteri & fiyat' => 'Birim & fiyat', 'Görseller' => 'Görseller', 'Acente komisyonu & tahsilat' => 'Komisyon & tahsilat', 'İptal & iade şartları' => 'İptal & iade']; $editorToc = []; $editorN = 0; foreach ($editorSections as $fullTitle => $shortTitle) { $editorN++; $editorToc[] = ['id' => 'sec-'.str_pad((string)$editorN, 2, '0', STR_PAD_LEFT), 'no' => str_pad((string)$editorN, 2, '0', STR_PAD_LEFT), 'title' => $fullTitle, 'short' => $shortTitle]; } $editorN = 0; ?>
