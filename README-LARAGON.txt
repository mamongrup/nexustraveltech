...
- Sari uyari 'Incele' (eski senkron) ical-takvimler sayfasinda ilgili ilanin 'Simdi iceri aktar' butonuna kaydirir + odaklar (4d9fbd3)
- tesis-ekle kurulum adimlari bolum capalarina baglandi: 01 -> temel bilgiler, 02 -> oda/birim (165eb8c)
- Eksik kalem baglantilarinda hedef bolum ipucu: 'Gorseller #sec-05' (3b262f3)
- Taninmayan webhook oda kodu onay bekleyen oneri olur; dagitim merkezi 3'ten Onayla/Reddet (f9db159, migration 047)
- Oda eslestirme bolumune son 30 islemde gorulen eslesmemis kodlar listesi (45754c7)
- Oda eslestirme satirina tek tikla dogrulama: son webhook kaydi satir altinda (0e92afb)
- Eksik kur cifti gunluk denetim gorevi: fx_rate_missing + onleyici tarama, admin'e e-posta (5a13740)
- Webhook fiyat donusumunun orijinal/hedef birimi fx_audit'e kaydedilir (84345b7, migration 048)
- Kur yonetimine EUR/USD/GBP base hizli giris satirlari (95f5488)
- Oda eslestirmesi fiyat planiyla birlikte: ayni satirda oda + plan cifti (f7dad40, migration 049)
- channel_webhook_loop_threshold kontrol merkezinden ayarlanabilir (4ebf2f8)
- iCal import/senkron islerine tekrar hata tespiti (45f6202, migration 050)
- Basarisiz webhook yukleri otomatik yeniden denenir, max 3 deneme geri adimli (05c8d01)
- Token'i olmayan kanal baglantilarini dolduran dogrulama komutu (d26c997)
- verify-platform ciktisina migration dosya durumlari eklendi (55819c5)
- Ozellik cop kutusu TTL suresi kontrol merkezinden ayarlanabilir (97bbdc5)
- Cop kutusu chip'lerine kalici silinme geri sayim etiketi (b8f4584)
- Cop kutusu temizligi oncesi 'son sans' onay epostasi (7369712, migration 051)
- Denetim kayitlarina tarih araligi + yonetici adi filtreleri (e980600)
- feature.restore detayi tablo olarak: ilan listesi + bolum sayisi (f8fe100)
