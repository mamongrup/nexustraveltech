...
<head>
  ...
  <style>
    ...
    .module-card:hover {
      ...
      box-shadow: 0 16px 32px rgba(7, 20, 18, 0.08);
      border-color: #c9d8c9;
    }
    .module-icon {
      width: 44px;
...
<body class="inner-page">
  <main>
    ...
    <section class="solutions-hero">
      <div class="shell">
        <div class="eyebrow"><i></i> TÜM TURİZM & OTELCİLİK ÇÖZÜMLERİ</div>
        <h1>Bulut Tabanlı, Uçtan Uca<br /><em>Turizm & Otel Teknolojileri</em></h1>
        <p>Ön bürodan kanal yöneticisine, restoran POS'tan ERP ve e-Dönüşüme kadar turizm işletmenizin tüm ihtiyaçları tek çatı altında.</p>
        <div class="solutions-nav-tabs">
          ...
          <a href="#ozel-cozumler"><i class="fa-solid fa-shapes"></i> Özel Çözümler</a>
        </div>
      </div>
    </section>
        ...
        <div class="module-grid">
          <div class="module-card pos" id="restoran-pos">
            <div>
              ...
              <h3>Restoran POS Yönetim Programı</h3>
    ...
    <section class="cta-banner">
      <div class="shell">
        <h2>Tüm Modülleri Tek Platformda Deneyimleyin</h2>
        <p>İşletmenizin büyüklüğüne göre ihtiyaç duyduğunuz modülleri seçin, hemen canlıya alın.</p>
        <a href="/nexustraveltech/#erken-erisim" class="button button-lime" style="padding:14px 28px;font-size:15px;font-weight:700">Erken Erişim & Demo Talep Et →</a>
      </div>
    </section>
