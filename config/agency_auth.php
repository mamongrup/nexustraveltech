...
function agency_session():void{if(session_status()!==PHP_SESSION_ACTIVE){session_name('nexus_agency');session_start(['cookie_httponly'=>true,'cookie_secure'=>!empty($_SERVER['HTTPS'])&&$_SERVER['HTTPS']!=='off','cookie_samesite'=>'Lax']);}}
