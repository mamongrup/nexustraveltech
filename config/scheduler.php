...
function scheduler_seed_defaults(): void
{
    $defaults = [
        ...
        ['nexus-chat-weekly', 'Haftalık sohbet özeti', 'cron/send-weekly-digest.php', '0 8 * * 1'],
        ...
        ['nexus-plan-missing-alerts', 'Planı eksik eşleştirme uyarıları', 'cron/alert-plan-missing.php', '*/15 * * * *'],
        ...
        ['nexus-trash-upcoming-alerts', 'Çöp kutusu yaklaşan kalıcı silme uyarıları', 'cron/alert-feature-trash-upcoming.php', '30 7 * * *'],
